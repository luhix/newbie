...
layui.define(['element','menu'],function(exports){ //提示：模块也可以依赖其它模块，如：layui.define('layer', callback);
  ...
  var luadmin = {
    ...
    init:function(address,obj,treeStatus,data) {

		menu.menuList(address,obj,treeStatus,data);
